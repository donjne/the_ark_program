...
use crate::states::{GovernancePool, MintNftArgs};
...
pub struct MintNft<'info> {
    ...
    #[account(
        ...
        seeds = [GovernancePool::NFT_PREFIX_SEED, governance_pool.key().as_ref(), args.symbol.as_bytes()], 
        bump
    )]
...
pub fn mint_nft(ctx: Context<MintNft>, args: MintNftArgs) -> Result<()> {
    ...
    governance_pool.nft_symbol = args.symbol.clone();
    ...
    // Transfer funds from signer to governance pool
    let transfer_instruction = system_instruction::transfer(
        &ctx.accounts.signer.key(),
        &governance_pool.key(),
        governance_pool.collection_price
    );
    ...
    anchor_lang::solana_program::program::invoke(
        ...
        &[
            ...
            governance_pool.to_account_info(),
            ctx.accounts.system_program.to_account_info(),
        ],
    )?;

    governance_pool.resources += 1;
    ...
    invoke_signed(
        ...
        &[
            ...
            governance_pool.to_account_info().clone(),
    ...
    governance_pool.nft_minted += 1;
    governance_pool.total_nft_token_supply += 1;
    ...
    emit!(NftMinted {
        ...
        symbol: args.symbol,
        uri: args.uri,
        cost: governance_pool.collection_price
    });
